...
void SingleplayerState::MakeLevel(Scene& pScene)
{
	...
	m_pManagerComponent->SetLevelComponent(pGameobject->GetComponent<LevelComponent>());
	...
	//
	//GameObject* pSpritesParent = new GameObject("Sprites");
	//pSpritesParent->AddComponent(new TransformComponent(pSpritesParent));
	//pScene.AddGameObject(pSpritesParent);
	//pSpritesParent->SetParent(pLevelGameobject);
	//
	//float scale{ 2.f };
	...
	//		}
	//		pScene.AddGameObject(pGameobject);
	//		pGameobject->SetParent(pSpritesParent);
	//	}
	//}
	//
	...
	//pCheese->SetTag("Food");
	//pCheese->SetParent(pIngridientParent);
	//pFoodComponent->GetSubject()->AddObserver(m_pScoreDisplay);
	//pScene.AddGameObject(pCheese);
	//
	//
	...
	//pBurgerBottom->SetParent(pIngridientParent);
	//pFoodComponent->GetSubject()->AddObserver(m_pScoreDisplay);
	//pScene.AddGameObject(pBurgerBottom);
	//
...
void SingleplayerState::MakeLevel3(dae::Scene& pScene)
{
	...
	GameObject* pGameobject = new GameObject("Collider 0");
	pGameobject->AddComponent(new TransformComponent(pGameobject, glm::vec3{ 193.f, 378.f, 0.f }));
	pGameobject->AddComponent(new ColliderComponent(pGameobject, 30, 40, glm::vec2{ 15.f, 20.f }));
	pGameobject->AddComponent(new RigidbodyComponent(pGameobject, b2_staticBody));
	pGameobject->SetParent(pColliderObject);
	...
	pGameobject = new GameObject("Collider 1");
	pGameobject->AddComponent(new TransformComponent(pGameobject, glm::vec3{ 96.f, 330.f, 0.f }));
	pGameobject->AddComponent(new ColliderComponent(pGameobject, 96.f, 48.f, glm::vec2{ 48.f, 24.f }));
	pGameobject->AddComponent(new RigidbodyComponent(pGameobject, b2_staticBody));
	pGameobject->SetParent(pColliderObject);
	...
	pGameobject = new GameObject("Collider 2");
	pGameobject->AddComponent(new TransformComponent(pGameobject, glm::vec3{ 224.f, 330.f, 0.f }));
	pGameobject->AddComponent(new ColliderComponent(pGameobject, 94.f, 48.f, glm::vec2{ 47.f, 24.f }));
	pGameobject->AddComponent(new RigidbodyComponent(pGameobject, b2_staticBody));
	pGameobject->SetParent(pColliderObject);
	...
	pGameobject = new GameObject("Collider 3");
	pGameobject->AddComponent(new TransformComponent(pGameobject, glm::vec3{ 224.f, 282.f, 0.f }));
	...
	pGameobject = new GameObject("Collider 5");
	pGameobject->AddComponent(new TransformComponent(pGameobject, glm::vec3{ 96.f, 250.f, 0.f }));
	pGameobject->AddComponent(new ColliderComponent(pGameobject, 48.f, 48.f, glm::vec2{ 24.f, 24.f }));
	pGameobject->AddComponent(new RigidbodyComponent(pGameobject, b2_staticBody));
	pGameobject->SetParent(pColliderObject);
	...
	pGameobject = new GameObject("Collider 6");
	pGameobject->AddComponent(new TransformComponent(pGameobject, glm::vec3{ 176.f, 250.f, 0.f }));
	pGameobject->AddComponent(new ColliderComponent(pGameobject, 16.f, 48.f, glm::vec2{ 8.f, 24.f }));
	pGameobject->AddComponent(new RigidbodyComponent(pGameobject, b2_staticBody));
	pGameobject->SetParent(pColliderObject);
	...
	pGameobject = new GameObject("Collider 7");
	pGameobject->AddComponent(new TransformComponent(pGameobject, glm::vec3{ 0.f, 186.f, 0.f }));
	pGameobject->AddComponent(new ColliderComponent(pGameobject, 96.f, 196.f, glm::vec2{ 48.f, 98.f }));
	pGameobject->AddComponent(new RigidbodyComponent(pGameobject, b2_staticBody));
	pGameobject->SetParent(pColliderObject);
	...
	pGameobject = new GameObject("Collider 8");
	pGameobject->AddComponent(new TransformComponent(pGameobject, glm::vec3{ 96.f, 186.f, 0.f }));
	pGameobject->AddComponent(new ColliderComponent(pGameobject, 48.f, 32.f, glm::vec2{ 24.f, 16.f }));
	pGameobject->AddComponent(new RigidbodyComponent(pGameobject, b2_staticBody));
	pGameobject->SetParent(pColliderObject);
	...
	pGameobject = new GameObject("Collider 9");
	pGameobject->AddComponent(new TransformComponent(pGameobject, glm::vec3{ 320.f, 186.f, 0.f }));
	pGameobject->AddComponent(new ColliderComponent(pGameobject, 96.f, 196.f, glm::vec2{ 48.f, 98.f }));
	pGameobject->AddComponent(new RigidbodyComponent(pGameobject, b2_staticBody));
	pGameobject->SetParent(pColliderObject);
	...
	pBurgerTop->AddComponent(new TransformComponent(pBurgerTop, glm::vec3(32.f, 34.f, 0.f), glm::vec2{ 2.f }));
	pBurgerTop->AddComponent(new SpriteRendererComponent(pBurgerTop, "BurgerTime_SpriteSheet.png", SDL_FRect{ 112.f, 48.f, 32.f, 8.f }));
	pBurgerTop->AddComponent(new ColliderComponent(pBurgerTop, 30.f, 4.f));
	pBurgerTop->AddComponent(new RigidbodyComponent(pBurgerTop, b2_dynamicBody, 1.0f, 1.0f, true, dae::PhysicsLayers::layer1));
	auto pFoodComponent = new FoodComponent(pBurgerTop, true);
	pBurgerTop->AddComponent(pFoodComponent);
	pBurgerTop->SetTag("Food");
	...
	pBurgerTop = new GameObject("Letuce 4");
	pBurgerTop->AddComponent(new TransformComponent(pBurgerTop, glm::vec3(128.f, 242.f, 0.f), glm::vec2{ 2.f }));
	pBurgerTop->AddComponent(new SpriteRendererComponent(pBurgerTop, "BurgerTime_SpriteSheet.png", SDL_FRect{ 112.f, 88.f, 32.f, 8.f }));
	pBurgerTop->AddComponent(new ColliderComponent(pBurgerTop, 30.f, 4.f));
	pBurgerTop->AddComponent(new RigidbodyComponent(pBurgerTop, b2_dynamicBody, 1.0f, 1.0f, true, dae::PhysicsLayers::layer1));
	pFoodComponent = new FoodComponent(pBurgerTop);
	...
	pBurgerTop = new GameObject("BurgerTop 1");
	pBurgerTop->AddComponent(new TransformComponent(pBurgerTop, glm::vec3(320.f, 34.f, 0.f), glm::vec2{ 2.f }));
	pBurgerTop->AddComponent(new SpriteRendererComponent(pBurgerTop, "BurgerTime_SpriteSheet.png", SDL_FRect{ 112.f, 48.f, 32.f, 8.f }));
	pBurgerTop->AddComponent(new ColliderComponent(pBurgerTop, 30.f, 4.f));
	pBurgerTop->AddComponent(new RigidbodyComponent(pBurgerTop, b2_dynamicBody, 1.0f, 1.0f, true, dae::PhysicsLayers::layer1));
